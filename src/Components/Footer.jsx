...
const Footer = () => {
  return (
    <>
      <footer className=" flex flex-col items-center  bg-[#142230] text-center text-white">
        <div className="container px-6 pt-6">
          <div className="mb-6 flex justify-center">
            
            <a
        href="https://www.linkedin.com/in/mushahid-hussain-86354b25b/"
        type="button"
      ...
      <a
        ...
        <div
          className="w-full bg-[#142230] p-4 text-center"
